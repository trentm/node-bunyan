...
You may add additional key/value pairs to the object passed to `createLogger` and they will appear in all the logs generated by the resulting logger object.
