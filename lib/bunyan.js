 ...
 */
function getCaller3Info(stackTraceLimit) {
    var obj = {};
    ...
    Error.prepareStackTrace = function (_, stack) {
        var caller = stack[stackTraceLimit-1];
...
function Logger(options, _childOptions, _childSimple) {
    ...
    if (parent && _childSimple) {
        ...
        this.stackTraceLimit = parent.stackTraceLimit || 3;
        this.src = parent.src;
    ...
    if (parent) {
        ...
        this.stackTraceLimit = options.stackTraceLimit || 3;
        this.src = false;
        this.fields = {};
    }
    ...
    return function () {
        ...
        function mkRecord(args) {
            ...
            if (log.src && !rec.src) {
                ...
                rec.src = getCaller3Info(log.stackTraceLimit);
            }
            rec.v = LOG_VERSION;
